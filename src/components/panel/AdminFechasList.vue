          ...
          <div class="p-6 bg-white dark:bg-gray-800 rounded-b-lg">
            <form @submit.prevent="saveFecha" class="space-y-6">
              ...
              <div class="flex justify-end space-x-3 mt-6">
                <button
                  type="submit"
                  class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition-colors duration-300"
                >
